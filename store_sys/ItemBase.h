...
#include "ItemType.h" // ItemType 중복 정의 방지
...
public:
    ...
    // HealthPotion override 문제 해결용
    virtual string virtualGetName() const { return name; }
    virtual int virtualGetPrice() const { return price; }
...
public:
    ...
    ItemType GetItemType() const override { return ItemType::HealthPotion; } // 기본 HealthPotion 호환
};
